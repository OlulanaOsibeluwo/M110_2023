...
int lineSensorpin_1 = 3;
int lineSensorpin_2 = 4;
int lineSensorpin_3 = 5;
int lineSensorpin_4 = 6;

int right_lineSensor = digitalRead(lineSensorpin_1); //3
int v_right_lineSensor = digitalRead(lineSensorpin_2); //4
int left_lineSensor = digitalRead(lineSensorpin_3); //5
int v_left_lineSensor = digitalRead(lineSensorpin_4);//6
